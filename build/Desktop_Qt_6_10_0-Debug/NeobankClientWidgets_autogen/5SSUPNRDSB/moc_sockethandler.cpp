...
void SocketHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->messageReceived((*reinterpret_cast<std::add_pointer_t<QJsonObject>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (SocketHandler::*)(const QString & )>(_a, &SocketHandler::errorOccurred, 4))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketHandler::*)(const QJsonObject & )>(_a, &SocketHandler::messageReceived, 5))
            return;
    }
}
...
// SIGNAL 5
void SocketHandler::messageReceived(const QJsonObject & _t1)
{
